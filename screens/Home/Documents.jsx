...
const Documents = () => {
  ...
  return (
    <View className="flex-1 p-4">
      ...
      {/* Dropdown for Yes/No */}
      <View className="border p-0 rounded mb-4">
       <RNPickerSelect
        value={taskCompleted}
        onValueChange={(value) => setTaskCompleted(value)}
        placeholder={{ label: "Task Completed (Yes/No)", value: null }}
        items={[
          { label: "Yes", value: "Yes" },
          { label: "No", value: "No" },
        ]}
        style={{
          inputAndroid: { borderWidth: 1, borderColor: 'black', padding:0, borderRadius: 5 },
          inputIOS: { borderWidth: 1, borderColor: 'black', borderRadius: 5 },
        }}
      />
      </View>
