  ...
  return (
    ...
    >
      ...
      >
        ...
        >{`${contentNumber}/${totalNumber} Task`}</Text>
      </ImageBackground>
    </View>
  );
};
        ...
        if (taskSnap.exists()) {
          ...
          if (projectIdsToFetch.length > 0) {
            ...
            if (projectSnap.exists()) {
              ...
              for (const [projectName, projectDetails] of Object.entries(
                projectsData
              )) {
    ...
    <ScrollView style={{ padding: 16, backgroundColor: "#FFFFFF" }}>
      ...
      >
        <View style={{ padding: 16, backgroundColor: "#FFFFFF" }}>
          ...
          >
            <Text
              style={{ fontWeight: "bold", fontSize: 14, color: "#4B5563" }}
            >
              Project Id
            </Text>
            <Text
          ...
          <View horizontal={true} showsHorizontalScrollIndicator={false}>
            {filteredData.map((project) => (
              ...
              >
                ...
                <Text style={{ color: "#4B5563", minWidth: 100 }}>
                  {project.projectId}
                </Text>
                <Text style={{ color: "#4B5563", minWidth: 150 }}>
                  {project.projectName}
                </Text>
                <Text style={{ color: "#4B5563", minWidth: 100 }}>
                  {tasks.taskId || "N/A"}
                ...
                <Text style={{ color: "#4B5563", minWidth: 120 }}>
                  {new Date("2024-08-30").toLocaleDateString()}
                </Text>
                
                <Text style={{ color: "#4B5563", minWidth: 120 }}>
                  {new Date("2024-09-04").toLocaleDateString()}
                </Text>{" "}
                {/* Update with dynamic task deadline */}
                <Text style={{ color: "#4B5563", minWidth: 120 }}>
                  Complete
                </Text>{" "}
                {/* Update task status */}
